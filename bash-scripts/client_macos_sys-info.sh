...
log_command_output "Application Details (system_profiler)" "system_profiler SPApplicationsDataType | grep -A 10 -i twingate"
...
log_command_output "LaunchAgents in /Library/LaunchAgents" "ls -la /Library/LaunchAgents"
log_command_output "LaunchDaemons in /Library/LaunchDaemons" "ls -la /Library/LaunchDaemons"
log_command_output "System LaunchAgents in /System/Library/LaunchAgents" "ls -la /System/Library/LaunchAgents"
log_command_output "System LaunchDaemons in /System/Library/LaunchDaemons" "ls -la /System/Library/LaunchDaemons"
